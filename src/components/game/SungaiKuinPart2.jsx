...
// Import file GeoJSON (sungai Kuin part 2)
import sungaiKuinPart2GeoJSON from './geojson/sungaikuinpart2.json';
...
const SungaiKuinPart2 = () => {
  ...
  const dbKey = gameState.dbKey || 'kuin_part2';
...
export default SungaiKuinPart2;