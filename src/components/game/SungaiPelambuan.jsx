...
// Import file GeoJSON (sungai Pelambuan / Kuin)
import sungaiPelambuanGeoJSON from './geojson/sungaipelambuan.json';
...
// Ekstrak koordinat sungai Pelambuan
const batasSungai = extractCoordinates(sungaiPelambuanGeoJSON);

// Fungsi untuk menghitung titik tengah
const calculateCenter = (coordinates) => {
  if (coordinates.length === 0) return [-3.3186, 114.5692];
...
// Titik Start dan Finish (sesuai data sungai Pelambuan)
const startPoint = [-3.3146, 114.5649];
const finishPoint = [-3.3226, 114.5735];
...
// ======== TAMBAHAN: FILTER LOKASI SUNGAI KUIN (PELAMBAN) ========
// Karena data JSON menggunakan "Sungai Kuin" untuk wilayah ini, kita filter berdasarkan itu
...
export default SungaiPelambuan;