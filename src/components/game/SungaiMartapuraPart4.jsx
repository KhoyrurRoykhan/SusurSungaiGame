...
// Import file GeoJSON
import sungaiBaritoGeoJSON from './geojson/sungaiawang.json';
...
const startPoint = [-3.3040, 114.6114]; // Titik paling selatan sebagai START
const finishPoint = [-3.3116, 114.5938]; // Titik paling utara sebagai FINISH
