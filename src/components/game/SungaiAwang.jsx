...
// Import file GeoJSON (sungai Awang)
import sungaiAwangGeoJSON from './geojson/sungaiawang.json';
...
// Ekstrak koordinat sungai Awang
const batasSungai = extractCoordinates(sungaiAwangGeoJSON);

// Fungsi untuk menghitung titik tengah
const calculateCenter = (coordinates) => {
  if (coordinates.length === 0) return [-3.2958, 114.6062];
...
// Titik Start dan Finish (sesuai data sungai Awang)
const startPoint = [-3.2891, 114.6013];
const finishPoint = [-3.3025, 114.6110];
...
// ======== TAMBAHAN: FILTER LOKASI SUNGAI AWANG ========
// Filter data dari Data_Sungai.json dengan Nama_Sungai === "Sungai Awang"
const lokasiSungaiAwang = dataSungai
  .filter(item => item.Nama_Sungai === "Sungai Awang")
  .map(item => {
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 relative">
          ...
          >
            ...
            {/* ======== TAMBAHAN: MARKER LOKASI SUNGAI AWANG ======== */}
            {lokasiSungaiAwang.map((lokasi, idx) => (
              <Marker
                key={idx}
        ...
        <div className="w-96 bg-gray-800 border-l border-gray-700 flex flex-col">
          ...
          {/* ======== TAMBAHAN: DAFTAR LOKASI SUNGAI AWANG ======== */}
          <div className="p-4 border-t border-gray-700 max-h-60 overflow-y-auto">
            <h3 className="text-sm font-bold text-gray-400 mb-3 flex items-center gap-2">
              <MapPin size={16} />
              Lokasi di Sungai Awang ({lokasiSungaiAwang.length})
            </h3>
            <div className="space-y-2 text-xs">
              {lokasiSungaiAwang.length === 0 ? (
