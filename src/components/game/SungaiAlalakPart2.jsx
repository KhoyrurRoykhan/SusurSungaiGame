...
import { 
  ...
  RotateCcw, 
  Terminal,
  MapPin,                 // ← ditambahkan untuk ikon daftar lokasi
  Clock,
  ArrowLeft,
  AlertCircle,
  Flag,
...
// Import file GeoJSON (sungai Alalak part 2)
import sungaiAlalakPart2GeoJSON from './geojson/sungaialalakpart2.json';
...
// Ekstrak koordinat sungai Alalak part 2
const batasSungai = extractCoordinates(sungaiAlalakPart2GeoJSON);

// Fungsi untuk menghitung titik tengah
const calculateCenter = (coordinates) => {
  if (coordinates.length === 0) return [-3.278, 114.621];
...
// Titik Start dan Finish (sesuai data sungai Alalak part 2)
...
// ======== TAMBAHAN: FILTER LOKASI SUNGAI ALALAK ========
// Filter data dari Data_Sungai.json dengan Nama_Sungai === "Sungai Alalak"
const lokasiSungaiAlalak = dataSungai
  .filter(item => item.Nama_Sungai === "Sungai Alalak")
  .map(item => {
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 relative">
          ...
          >
            ...
            {/* ======== TAMBAHAN: MARKER LOKASI SUNGAI ALALAK ======== */}
            {lokasiSungaiAlalak.map((lokasi, idx) => (
              <Marker
                key={idx}
        ...
        <div className="w-96 bg-gray-800 border-l border-gray-700 flex flex-col">
          ...
          {/* ======== TAMBAHAN: DAFTAR LOKASI SUNGAI ALALAK ======== */}
          <div className="p-4 border-t border-gray-700 max-h-60 overflow-y-auto">
            <h3 className="text-sm font-bold text-gray-400 mb-3 flex items-center gap-2">
              <MapPin size={16} />
              Lokasi di Sungai Alalak ({lokasiSungaiAlalak.length})
            </h3>
            <div className="space-y-2 text-xs">
              {lokasiSungaiAlalak.length === 0 ? (
...
export default SungaiAlalakPart2;