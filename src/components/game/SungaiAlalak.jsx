...
// Import file GeoJSON sungai Alalak
import sungaiAlalakGeoJSON from './geojson/sungaialalak.json';
...
// Ekstrak koordinat sungai Alalak
const batasSungai = extractCoordinates(sungaiAlalakGeoJSON);

// Fungsi untuk menghitung titik tengah
const calculateCenter = (coordinates) => {
  if (coordinates.length === 0) return [-3.285, 114.583];
...
// Titik Start dan Finish (sesuai data sungai Alalak)
const startPoint = [-3.2814, 114.5667];
const finishPoint = [-3.2884, 114.6008];
...
// ======== FILTER LOKASI SUNGAI ALALAK ========
// Filter lokasi dengan Nama_Sungai === "Sungai Alalak" dan parsing koordinat
