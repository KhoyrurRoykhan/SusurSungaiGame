...
// Import file GeoJSON (sungai Kuin part 3)
import sungaiKuinPart3GeoJSON from './geojson/sungaikuinpart3.json';
...
// Ekstrak koordinat sungai Kuin part 3
const batasSungai = extractCoordinates(sungaiKuinPart3GeoJSON);

// Fungsi untuk menghitung titik tengah
const calculateCenter = (coordinates) => {
  if (coordinates.length === 0) return [-3.3065, 114.5903];
...
// Titik Start dan Finish (sesuai data sungai Kuin part 3)
const startPoint = [-3.3036, 114.5863];
const finishPoint = [-3.3093, 114.5943];
...
export default SungaiKuinPart3;