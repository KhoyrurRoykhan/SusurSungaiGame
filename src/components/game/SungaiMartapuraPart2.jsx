...
// Import file GeoJSON (sungai Martapura part 2)
import sungaiMartapuraPart2GeoJSON from './geojson/sungaimartapurapart2.json';
...
// Ekstrak koordinat sungai Martapura part 2
const batasSungai = extractCoordinates(sungaiMartapuraPart2GeoJSON);

// Fungsi untuk menghitung titik tengah
const calculateCenter = (coordinates) => {
  if (coordinates.length === 0) return [-3.3354, 114.5826];
...
// Titik Start dan Finish (sesuai data sungai Martapura part 2)
const startPoint = [-3.3432, 114.5707];
const finishPoint = [-3.3276, 114.5945];
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 relative">
          ...
          >
            ...
            <GeoJSON 
              data={sungaiMartapuraPart2GeoJSON}
              style={polygonStyle}
              ref={geojsonRef}
            />
...
export default SungaiMartapuraPart2;