...
// Import file GeoJSON
import sungaiBaritoGeoJSON from './geojson/sungaialalakpart2.json';
...
const startPoint = [-3.2886, 114.6012]; // Titik paling selatan sebagai START
const finishPoint = [-3.2675, 114.6412]; // Titik paling utara sebagai FINISH
